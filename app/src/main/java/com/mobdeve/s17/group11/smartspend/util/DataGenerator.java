...
public class DataGenerator {
    ...
    public static List<BudgetsListItem> getBudgetDataList() {
        ...
        for(int i = 0; i < 50; i++) {
            items.add(new BudgetsListItem(rand.nextInt(2) == 0 ? ExpensesCategory.FOOD_AND_DRINKS : ExpensesCategory.TRANSPORTATION, rand.nextFloat() * 5000.0f, new Date(14, 10, 2025), new Date(14, 11, 2025)));
        }
